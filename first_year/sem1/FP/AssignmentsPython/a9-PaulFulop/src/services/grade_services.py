...
class GradeServices():
    ...
    """
    def __init__(self, grade_repo, disc_repo, stud_repo, ur_serv):
    ...
    def grade_student(self, new_grade:Grade):
        ...
        undo_func = FunctionCall(self.__grade_repo.data.pop)
        redo_func = FunctionCall(self.__grade_repo.add, new_grade)
