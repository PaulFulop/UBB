...
{
	DynamicVector<int> testVector = DynamicVector<int>();

	assert(testVector.capacity == 1);
	assert(testVector.length == 0);

	assert(testVector.Add(1) == true);
	assert(testVector.Add(2) == true);
	assert(testVector.Add(1) == false);

	assert(testVector.capacity == 2);
	assert(testVector.length == 2);

	DynamicVector<int> testVector1 = DynamicVector<int>();
	testVector1 = testVector;
	assert(testVector1.length == 2);

	DynamicVector<int> testVector2 = DynamicVector<int>(testVector);
	assert(testVector1.length == 2);

	assert(testVector.Remove(2) == true);
	assert(testVector.Remove(2) == false);
	assert(testVector.length == 1);

	assert(testVector.Update(1, 2) == true);
	assert(testVector.Update(1, 3) == false);

	assert(testVector.Search(2) == 0);
	assert(testVector.Search(1) == -1);
